  ...
  return (
    ...
    >
      <View style={styles.cardContainer}>
        <Text style={typography.title}>{`Welcome to Hotel AibohphobiA!`}</Text>
        <Text style={[typography.body, styles.textStyle]}>
          {`These terms and conditions outline the rules and regulations for the use of Hotel's Website, located at aibohphobia.com.`}
        </Text>
        <Text style={[typography.body, styles.textStyle]}>
          {`By accessing this website we assume you accept these terms and conditions. Do not continue to use Hotel AibohphobiA if you do not agree to take all of the terms and conditions stated on this page`}
        </Text>
        <Text style={[typography.body, styles.textStyle]}>
        ...
        <Text style={[typography.body, styles.textStyle]}>
          {`We employ the use of cookies. By accessing Hotel AibohphobiA, you agreed to use cookies in agreement with the Hotel's Privacy Policy.`}
        </Text>
        <Text style={[typography.body, styles.textStyle]}>
        ...
        <Text style={[typography.body, styles.textStyle]}>
          {`Unless otherwise stated, Hotel and/or its licensors own the intellectual property rights for all material on Hotel AibohphobiA. All intellectual property rights are reserved. You may access this from Hotel AibohphobiA for your own personal use subjected to restrictions set in these terms and conditions.`}
        </Text>
        <Text style={[typography.body, styles.textStyle]}>
